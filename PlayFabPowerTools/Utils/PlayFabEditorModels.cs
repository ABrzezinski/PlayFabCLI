...
namespace PlayFab.EditorModels
{
    ...
    public class RegisterAccountResult : PlayFabResultCommon
    {
    ...
    public class LogoutResult : PlayFabResultCommon
    {
    }
    ...
    public class CreateTitleResult : PlayFabResultCommon
    {
    ...
    {
        public PlayFab.EditorModels.Studio Studio;
    ...
    {
        public PlayFab.EditorModels.Title Title;
        public bool isCollapsed = true;
    }
